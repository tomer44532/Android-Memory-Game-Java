...
public class ForestTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = (ViewGroup) inflater.inflate(R.layout.forest_tab,container,false);

        setInterface((ClickInterface) getActivity());

        Button forestBtn = rootView.findViewById(R.id.forest_select);
    ...
    public void onResume() {
        ...
        if (isVisible() && !isHidden() && rootView !=null)
        {
    ...
    public void setMenuVisibility(final boolean visible) {
        ...
        ///((ClickInterface)getActivity()).defaultTab();
        if (visible&&rootView !=null) {
/*            setInterface((ClickInterface) getActivity());
            clickInterface.defaultTab();*/
