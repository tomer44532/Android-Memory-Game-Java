...
public class CityTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rootView = (ViewGroup) inflater.inflate(R.layout.city_tab,container,false);

        setInterface((ClickInterface) getActivity());

        Button citytBtn = rootView.findViewById(R.id.city_select);
        citytBtn.setOnClickListener(new View.OnClickListener() {
            @Override
